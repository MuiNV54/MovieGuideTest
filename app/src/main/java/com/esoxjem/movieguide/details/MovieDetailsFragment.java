...
public class MovieDetailsFragment extends Fragment
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            MovieModel movie = (MovieModel) getArguments().get(Constants.MOVIE);
            if (movie != null) {
                this.movie = movie;
    ...
    public void showDetails(MovieModel movie) {
        ...
        releaseDate.setText(
                String.format(getString(R.string.release_date), movie.getReleaseDate()));
        rating.setText(
    ...
    public void showTrailers(List<Video> trailers) {
        if (trailers.isEmpty()) {
            ...
            RequestOptions options = new RequestOptions().placeholder(R.color.colorPrimary)
                    .centerCrop()
                    .override(150, 150);
